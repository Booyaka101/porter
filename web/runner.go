...
//
//	func main() {
//	    web.EmbeddedScripts = scripts
//	    web.SetScriptDiscoveryConfig(&web.ScriptDiscoveryConfig{
...
//	    web.SetAIAgentConfig(&web.AIAgentConfig{
//	        Provider: "openai", // or "anthropic", "ollama"
//	        Model:    "gpt-4",
//	        ScriptDescriptions: map[string]web.ScriptDescription{
//	            "deploy.sh": {
//	                Name:        "deploy.sh",
...
//	    })
//
//	    web.Run(web.RunConfig{UIBuildFS: ui})
//	}
